...
// Vortex demo: use the bare RN Image (no skeleton/fallback wrapper) so the
// Vortex logo on the onboarding renders transparently without OneKey's
// Image component painting a Skeleton with $bgApp underneath.
  ...
  return (
    ...
    >
      <YStack
        ...
        gap="$8"
      >
        {/* Vortex demo: OneKey wordmark replaced with our brand
            (icon comes from packages/components/assets/vortex-logo.png — the
            same 512x512 source IconKitchen generated the launcher icon from). */}
        <XStack gap="$3" alignItems="center" h={72}>
          <RNImage
            source={require('@onekeyhq/components/assets/vortex-logo.png')}
            style={{ width: 72, height: 72, backgroundColor: 'transparent' }}
            resizeMode="contain"
          />
          <SizableText size="$heading4xl" fontWeight="800" color="$text">
            Vortex
          </SizableText>
        </XStack>
        {platformEnv.isNative ? (
