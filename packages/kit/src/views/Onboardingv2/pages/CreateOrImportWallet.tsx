...
function CreateOrImportWallet() {
  ...
  const options: IImportOption[] = useMemo(() => {
    ...
    return [
      // Vortex demo: "Continue with Google" / "Continue with Apple" removed.
      null,
      null,
      {
      ...
      // Vortex demo: Google Drive / iCloud backup option removed.
      null,
      // Vortex demo: OneKey Lite and OneKey KeyTag import options removed.
      null,
      null,
      {
        key: 'watch',
