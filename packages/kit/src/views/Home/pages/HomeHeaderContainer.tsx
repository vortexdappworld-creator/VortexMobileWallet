...
function BaseHomeHeaderContainer() {
  ...
  // Vortex demo: marketing promo banners (e.g. "SpaceX Perps are live") are
  // disabled. Flip to true to restore OneKey's banner band.
  const PROMO_BANNERS_ENABLED = false;
