...
function AddressInfo(props: IProps) {
  ...
  // Vortex demo: render a branded badge whenever the rendered address is the
  // Vortex contract, even if there's no walletAccountName / addressBookName.
  const isVortexAddress =
    typeof address === 'string' &&
    address.toLowerCase() === '0x729f8f6a6970cfc7acae555236a20751c1501f39';
  ...
  const renderVortexBadge = () => {
    if (!isVortexAddress) return null;
    return (
      <Badge badgeType="success" badgeSize="sm">
        Vortex official contract
      </Badge>
    );
  };
